    ...
    <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-1.5">
          <Label htmlFor="addressLine1" className="text-slate-700">Street address</Label>
          <Input
            id="addressLine1"
        ...
        <div className="space-y-1.5">
          <Label htmlFor="addressLine2" className="text-slate-700">
            Estate / apartment <span className="text-slate-400">(optional)</span>
          </Label>
          <Input
            id="addressLine2"
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="countyProvince" className="text-slate-700">
              County / province <span className="text-slate-400">(optional)</span>
            </Label>
            <Input
              id="countyProvince"
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1.5">
            <Label className="text-slate-700">Proof document type</Label>
            <Controller
              control={form.control}
              name="proofDocType"
              render={({ field }) => (
          ...
          <div className="space-y-1.5">
            <Label htmlFor="proofPeriod" className="text-slate-700">Document period</Label>
            <Input
              id="proofPeriod"
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1.5">
            <Label className="text-slate-700">Employment status</Label>
            <Controller
              control={form.control}
          ...
          <div className="space-y-1.5">
            <Label className="text-slate-700">Monthly income band</Label>
            <Controller
              control={form.control}
        ...
        <div className="space-y-2">
          <Label className="text-slate-700">Source of funds <span className="text-red-400">*</span></Label>
        ...
        <div className="space-y-1.5">
          <Label htmlFor="taxIdNumber" className="text-slate-700">
            KRA PIN / Tax ID <span className="text-slate-400">(optional)</span>
          </Label>
          <Input
            id="taxIdNumber"
      ...
      <div className="space-y-4">
          ...
          render={({ field }) => (
            <label className="flex items-start gap-3 cursor-pointer">
              <Checkbox
                ...
                className="mt-0.5 border-gray-300 data-[state=checked]:bg-teal-600 data-[state=checked]:border-teal-600"
              />
        ...
        <div className="bg-gray-100/50 border border-gray-300 rounded-lg p-4 space-y-3">
